...
/*   Updated: 2023/02/01 20:14:09 by rvrignon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string name, unsigned int const gradeToSign, unsigned int const gradeToExecute) : _name(name), _sign(0), _gradeToSign(gradeToSign), _gradeToExecute(gradeToExecute) {
